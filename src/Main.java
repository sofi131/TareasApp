...
public class Main {
    public static void main(String[] args) {
        User user= new User();
        user.insertar("(username,password,idrol) values (?,?,?)","pepito","1234","2");
    }
//        String usr,pass;
...
//            switch (op){
//                case "1":
//                    crearUsuario(leer,tareas);
//                    break;
//                case "2":
//                    editarUsuario(leer,tareas);
//                    break;
//                case "3":
//                    borrarUsuario(leer, tareas);
//                case "4":
//                    verUsuario(leer, tareas);
//                case "5":
//                    verTareasAdmin(leer, tareas);
//                case "6":
...
//            switch (op){
//                case "1":
//                    verTareas(leer,tareas);
//                    break;
//                case "2":
//                    crearTareas(leer,tareas);
//                    break;
//                case "3":
//                    editarTareas(leer,tareas);
//                case "4":
//                    borrarTareas(leer,tareas);
//                case "5":
//                    System.out.println("Saliendo...");
//                    break;
//                default:
